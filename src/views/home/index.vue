      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <div class="out-border">
            ...
            <div class="color-main" style="padding: 20px; font-size: 18px;">
    ...
    <div class="un-handle-layout">
      ...
      <div class="un-handle-content">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">广告为即将到期</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      setTimeout(() => {
        this.chartData = {
          colums: ['date', 'orderCount', 'orderAmount'],
          rows: []
        };
